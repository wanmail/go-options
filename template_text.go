...
{{ $defaultFuncName := or $.defaultFuncName (printf "default%sOptions" (ToPublic $.configTypeName)) }}
...
func {{ $defaultFuncName }}() *{{ $.configTypeName }} {
    c := new({{ $.configTypeName }})
...
{{ if $.createDefaultFunc }}
func NewDefault{{ $.configTypeName | ToPublic}}() *{{ $.configTypeName }} {
